  ...
  return (
    <div className="relative w-full max-w-md">
      <input
        ...
        className="w-full border-2 border-transparent px-4 py-2 bg-white outline-none focus:border-[var(--green-White-BG)]"
      />

      {open && filteredMarkers.length > 0 && (
        <div className="absolute z-[1000] w-full border-gray-500 bg-white shadow-lg"> {/* bg-white to make abckground white*/ }
